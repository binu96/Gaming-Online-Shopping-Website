...
<body>
   ...
   <div id="Cover">
        <div id="box1">
            <img src="../images/gta5.jpg" width="50%" height = "47%"/>
            <div id="subbox1">
            ...
            <div id="subbox2">
                <form = "frm1" method="post" action="shoppingCart.php" onsubmit="return validate()">
	            <input type="hidden" name="product" value="GTA V">
	            <br>Quantity &nbsp <input type="text" name='qty' size="2" id="qty" value="">
        ...
        <div id="box2">
            <img src="../images/Fifa_16.jpg" width="50%" height = "47%"/>
            <div id="subbox1">
        ...
        <div id="box3">
            <img src="../images/nfs.jpg" width="50%" height = "47%"/>
            <div id="subbox1">
        ...
        <div id="box4">
            <img src="../images/bf4.jpg" width="50%" height = "47%"/>
            <div id="subbox1">
